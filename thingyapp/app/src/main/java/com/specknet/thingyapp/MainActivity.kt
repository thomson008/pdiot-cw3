package com.specknet.thingyapp
...
import com.specknet.thingyapp.bluetooth.ConnectingActivity
import com.specknet.thingyapp.live.LiveDataActivity
import com.specknet.thingyapp.onboarding.OnBoardingActivity
import com.specknet.thingyapp.utils.Constants
import com.specknet.thingyapp.utils.Utils
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        respeckStatusReceiver = object : BroadcastReceiver() {
            override fun onReceive(context: Context, intent: Intent) {
                ...
                when(action) {
                    Constants.ACTION_RESPECK_CONNECTED -> respeckStatus.text = "Thingy status: Connected"
                    Constants.ACTION_RESPECK_DISCONNECTED -> respeckStatus.text = "Thingy status: Disconnected"
    ...
    fun setupRespeckStatus() {
        ...
        if (sharedPreferences.contains(Constants.RESPECK_MAC_ADDRESS_PREF)) {
            ...
            respeckStatus.text = "Thingy status: Connecting..."
            ...
            respeckStatus.text = "Thingy status: Unpaired"
        }
    }
